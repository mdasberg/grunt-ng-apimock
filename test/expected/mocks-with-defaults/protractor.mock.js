(function () {
    'use strict';
    var passThroughs = [{"expression":"partials/.*","method":"GET","response":{}},{"expression":"/online/rest/some/api","method":"GET","isArray":true,"response":{}},{"expression":"/online/rest/some/api","method":"POST","response":{}},{"expression":"non-existing-custom-json/.*","method":"GET","response":{}}];
